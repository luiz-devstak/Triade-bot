...
module.exports = {
    name: 'RegisterCommand', // Nome do arquivo
    aliases: ['r', 'registrar'], // Sinonimos
    run: async (client, message, args) => {
        ...
        const generodrop = new MessageActionRow()
            .addComponents(
        ...
        const idadedrop = new MessageActionRow()
            .addComponents(
                new MessageSelectMenu()
        ...
        const sexualidadedrop = new MessageActionRow()
            .addComponents(
                new MessageSelectMenu()
        ...
        const Estadodrop = new MessageActionRow()
            .addComponents(
                new MessageSelectMenu()
                ...
                coletor.on('collect', async (collected) => {
                    ...
                    coletor.on('collect', async (collected) => {
                        ...
                        if (ticket === 'solteiro1') {
                            ...
                            message.guild.channels.cache.get(`1005559926216740994`).send({ embeds: [completo] })
